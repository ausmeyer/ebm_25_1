...
:::{.incremental}
- **Variable Types Matter:** Eventually, you will need to recognize whether data is continuous, discrete, nominal, or ordinal to pick he right statistical tests.

- **Central Tendency:** For these questions, use mean for normal distributions and probably median for skewed distributions.

- **Standard Deviations:** In normal distributions, ±1 SD = 68%, ±2 SD = 95%, ±3 SD = 99.7% for the width of the CI.
